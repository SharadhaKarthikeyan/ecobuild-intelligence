...
## Project Overview
Educational institutions, commercial organizations, and real estate portfolio managers often face challenges in monitoring building energy usage, utility costs, carbon emissions, and maintenance risks across multiple properties.

EcoBuild Intelligence is a building performance analytics platform that identifies high-cost, high-emission, and operationally inefficient buildings. It analyzes key factors such as energy consumption, carbon intensity, aging HVAC systems, poor insulation, inefficient window glazing, and retrofit potential. By combining building operations data with risk scoring and retrofit modeling, the project demonstrates how data analytics can support facility management, sustainability planning, and ESG decision-making.

## Project Background
EcoBuild Intelligence was developed as an expanded version of my previous Sustainable Building Performance Analytics Dashboard. While the earlier project focused on energy efficiency, construction costs, carbon emissions, retrofit priorities, and lifecycle operating costs, this version extends the concept into a more complete building performance intelligence platform.

The project adds structured data validation, modular metric calculation, multi-factor risk scoring, retrofit prioritization, SQLite-backed storage, interactive Plotly dashboards, and AI-assisted reporting with a rule-based fallback system. The goal is to simulate how facility managers, sustainability teams, architects, and consultants can use building data to make informed decisions about energy performance, operating costs, carbon impact, and retrofit planning.
